//map() = used for to creat new array, karon eita new array toiri kore.
	.map = this array use for easy equation like i want to do 2**3 = 6 . So, i can do this || let arr = [1,2,3,4,5] || then if i say 
	let newArr = ((e)=>{
		return e**2})
	console.log(newArr)
    then i will find the exact result square by using same thuri we can do + - / *

//.filter = its used to get some number specifically let me clear
	//Here is a array
	let arr2 = [55,40,30,15.18,12,9,4,5]
